...
const Services = () => {
  return (
    <div className="w-full min-h-[80vh] flex items-center  bg-primary text-background relative overflow-hidden">
      ...
      <FadeElement className="w-full h-full " direction="up">
        <div className="wrapper gap-4 flex flex-col">
          ...
          <CustomButton
            ...
            className="text-lg bg-white text-primary w-fit mt-8 hover:bg-white/95 font-semibold"
          />
        </div>
      </FadeElement>
    </div>
